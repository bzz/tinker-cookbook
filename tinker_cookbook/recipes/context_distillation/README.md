# Context distillation (language classification benchmark)
...
|---|---|---|
| Off-policy SL | Teacher-generated labels, cross-entropy | [`prompt_distillation/train.py`](../prompt_distillation/train.py) |
